...
var Resource = (function () {
    ...
    Resource.prototype.getRelationArray = function (type, relation, options) {
        ...
        result.observable = this.http.get(resource_helper_1.ResourceHelper.getProxy(this._links[relation].href), { headers: resource_helper_1.ResourceHelper.headers, params: params });
